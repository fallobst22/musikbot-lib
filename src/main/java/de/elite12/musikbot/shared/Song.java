...
public class Song implements Serializable {
	...
	public Song(int id, Timestamp inserted, String autor, String name,
			String link, boolean played, boolean skipped, Timestamp playedat,
			int sort, int dauer) {
		this.id = id;
	...
	public String toString() {
		return "Song [id=" + id + ", link=" + link + ", autor=" + autor
				+ ", title=" + title + "]";
	}
