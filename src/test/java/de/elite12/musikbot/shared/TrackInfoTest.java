...
public class TrackInfoTest {
	...
	public final void testVertifyTrack() {
		...
		if(track == null) {
			...
			assertEquals(this.length, new Integer((int) Math.round(new Integer(track.getDuration()).doubleValue()/1000)));
	...
	public static Collection input() {
		return Arrays.asList(new Object[][] {
				 {null,null,null,null},
				 {"",null,null,null},
				 {"asdblub",null,null,null},
				 {"0BCPKOYdS2jbQ8iyB56Zns",new Integer(308),"Clocks","Coldplay"},
				 ...
				 {"5pqF0qKSQCEq5mt5CFEXoq",new Integer(219),"Willst du","Alligatoah"},
				 {"5xioIPasd2HexKl3QsI8JDlG8",null,null,null},
				 {"5xioIP2HexKl3fQsI8JDlG8",null,null,null},
